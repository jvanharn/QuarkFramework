 ...
 * MySQL Query Result
 */
class MySQLResult implements \IteratorAggregate, \Quark\Database\Result {
	/**
	 * MySQL PDO Result Statement
	 * @var \PDOStatement
	 */
	protected $stmt;
	...
	/**
	 * Initiate the MySQL Resultset.
	 * @param \PDOStatement $stmt PDOStatement on MySQL connection to wrap.
